 ...
 */
public class MultiFileRestorePanelOld extends PFWizardPanel {

    private static final Logger log = Logger
        .getLogger(MultiFileRestorePanelOld.class.getName());
     ...
     */
    public MultiFileRestorePanelOld(Controller controller, Folder folder,
