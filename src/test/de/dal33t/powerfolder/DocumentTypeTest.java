...
public class DocumentTypeTest {
    ...
    public void testCategoryOfKnownExtensions() {
        ...
        assertEquals("spreadsheet", DocumentType.categoryOf("csv"),
                "a comma separated table is a spreadsheet, not prose");
        ...
        assertEquals("pdf", DocumentType.categoryOf("pdf"), "a pdf is its own kind of file");
        assertEquals("text", DocumentType.categoryOf("txt"));
        assertEquals("archive", DocumentType.categoryOf("zip"));
        assertEquals("document", DocumentType.categoryOf("djvu"),
                "a scanned document is a document, not audio");
    }
    ...
    public void testCategoriesAreOfferedDocumentsFirstAndFoldersLast() {
        ...
        assertFalse(categories.contains("other"), "\"none of the above\" is no filter");
    }
    ...
    public void testEveryTypeHasACategoryAndExtensions() {
        for (DocumentType type : DocumentType.values()) {
            ...
            assertFalse(type.getExtensions().isEmpty(), type + " has no extensions");
        }
    }
}
