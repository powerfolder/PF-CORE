...
public class JavaVersionTest {
    ...
    public void testOpenJDKVersion() {
        ...
        // PFS-5561: JavaVersion.parse currently folds the trailing build/extra
        // numbers ("36" + "1562") into the revision - assert the actual (and
        // develop_27-documented) behaviour, not the migration branch's stray 0.
