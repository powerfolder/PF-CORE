...
public class UtilTest {
    ...
    @Test
    @org.junit.jupiter.api.Disabled("PFS-5561: AWT system-clipboard access crashes the forked JVM on a non-interactive CI Windows session (service, no window station); needs an interactive desktop")
