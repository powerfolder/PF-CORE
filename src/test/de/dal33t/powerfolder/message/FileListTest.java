...
public class FileListTest extends TestCase {
    ...
    private static FolderInfo createRandomFolderInfo() {
        ...
        // Ahmad: Test please delete if not correct
        //FolderInfo foInfo = FolderInfoFactory.newTopFolderForTest("TestFolder / " + UUID.randomUUID(),IdGenerator.makeFolderId());
        FolderInfo foInfo = FolderInfoFactory.newTopFolderForTest("TestFolder / ");
        return foInfo;
    }
}
