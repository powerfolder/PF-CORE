...
public class FileNameProblemTest extends TestCase {
    ...
    public void testForWindows() {
        ...
        // reserved windows words like AUX (extentions behind it are also not allowed)
        ...
        try {
            ...
            for (int i = 0; i < methods.length; ++i) {
                ...
                if (method.getName().equals("stripExtension")) {
                    ...
                    assertEquals("test",(String) method.invoke(null,  new Object[]{"test.text"}));
                    assertEquals("test",(String) method.invoke(null,  new Object[]{"test"}));                    
                    break;
                }
            }
