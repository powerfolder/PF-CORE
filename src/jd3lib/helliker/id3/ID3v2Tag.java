    ...
    try {
      ...
      if (mpegOffset >= curSize) {          
        ...
        if (raf.read(previous_file) != previous_file.length) {
          throw new IOException("ID3v2Tag.writeTag: unexpected"
...
*/
  ...
  public void setUserDefinedURLFrame(String description, String value) {
    ...
    public ID3v2Comment getComment() throws ID3v2FormatException {
        if (frames.containsKey(ID3v2Frames.COMMENTS)) {
            return ((ID3v2Frame) frames.get(ID3v2Frames.COMMENTS)).getComment();
        } else {
            return null;
        }
    }
    ...
    public ID3v2UserDefinedURL getUserDefinedURL() throws ID3v2FormatException {
        if (frames.containsKey(ID3v2Frames.USER_DEFINED_URL)) {
            return ((ID3v2Frame) frames.get(ID3v2Frames.USER_DEFINED_URL)).getUserDefinedURL();
        } else {
            return null;
        }
    }
