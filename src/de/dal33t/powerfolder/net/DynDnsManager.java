...
/**
 * The DynDnsManager class is responsible for:
 * - to provide services to the DynDns updates and,
 * - DynDns validation as well as some UI utility methods.
 * 
...
public class DynDnsManager extends PFComponent {
            ...
            if (getController().getConnectionListener() != null) {
                ...
                switch ( res ) {
                	...
                	case ConnectionListener.OK:
                		log().info("Successfully validated dyndns '" + dynDns + "'");
				// getController().getUIController()
				// .showMessage(null,
				// "Success",
				//            	    	        Translation.getTranslation("preferences.dialog.statusDynDnsSuccess", dynDns));
                }
            }
        ...
        switch(type) {
        	...
        	case ErrorManager.UNKNOWN:
        	 getController().getUIController()
    	    	.showErrorMessage(
    	    	        Translation.getTranslation("preferences.dialog.dyndnsUpdateTitle"),
    	    	        Translation.getTranslation("preferences.dialog.dyndnsUpdateUnknowError"), null);
        	break;
   ...
   public final void close() {
    ...
    public boolean ipCheck(){
        String currentDyndnsIP = getHostIP(getController().getConfig().getProperty("mydyndns"));
