...
/**
 * use for caching, any value may return null at any moment ;-) from:
 * http://www.enterprisedeveloper.com/developers/javaspecialist/Issue015.html
 * 
 * @version $Revision: 1.2 $
 */
public class SoftHashMap extends AbstractMap {
    /** The internal HashMap that will hold the SoftReference. */
    private final Map hash = Collections.synchronizedMap(new HashMap());
