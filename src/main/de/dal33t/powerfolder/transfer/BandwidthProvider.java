...
/**
 * A BandwidthProvider can be used to periodically assign BandwidthLimiters 
 * a given amount of bandwidth. It uses a one Thread solution to perform this.
 * 
 * 
...
public class BandwidthProvider extends Loggable {
    ...
    private Map<BandwidthLimiter, Long> limits =
     ...
     * @param limiter
     * @param bps the number of bandwidth per second to apply. 0 will set
     *  the limiter to unlimited bandwidth. If you want to stop granting
     *  bandwidth, remove the limiter. If the parameter is negativ, nothing
     *  happens.
     */
    ...
    /**
     * Removes a limiter from getting bandwidth pushed.
     * (This class only holds weak references to BandwidthLimiters, so
     * even if you don't call this method the limiters get removed as soon as
     * the garbage collector clears them)
     * @param limiter the limiter to remove 
     */
