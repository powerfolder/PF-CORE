...
import de.dal33t.powerfolder.protocol.PermissionActivityProto;
 ...
 */
@Entity
public class PermissionActivity implements D2DObject {
    @Id
    @Column(length = 32)
    ...
    PermissionActivity(@NotNull FolderInfo folderInfo,
    ...
    public AbstractMessage toD2D() {
        PermissionActivityProto.PermissionActivity.Builder builder = PermissionActivityProto.PermissionActivity.newBuilder();
