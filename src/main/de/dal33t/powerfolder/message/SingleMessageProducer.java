...
public abstract class SingleMessageProducer implements MessageProducer {
    ...
    public final Message[] getMessages(boolean useExt) {
        return new Message[]{getMessage(useExt)};
    }
}
