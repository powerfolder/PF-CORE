...
public class InvitationAcceptRequest extends Message implements D2DObject {
    private static final long serialVersionUID = 100L;
    private static final Logger LOG = Logger.getLogger(InvitationAcceptRequest.class.getName());
    ...
    so the subjects and objects (as Permission objects) are stored directly in the InvitationAcceptRequest message.
     ...
     **/
    public InvitationAcceptRequest(AbstractMessage mesg) {
        initFromD2D(mesg);
    }
    ...
    public void initFromD2D(AbstractMessage mesg) {
        if (mesg instanceof InvitationAcceptRequestProto.InvitationAcceptRequest) {
            InvitationAcceptRequestProto.InvitationAcceptRequest proto = (InvitationAcceptRequestProto.InvitationAcceptRequest) mesg;
            ...
            // The Permission message cannot store subjects, hence they are stored in the InvitationAcceptRequest message
