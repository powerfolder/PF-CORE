...
public class PermissionChangeRequest extends Message implements D2DObject {
    private static final long serialVersionUID = 100L;
    private static final Logger LOG = Logger.getLogger(PermissionChangeRequest.class.getName());
    ...
    so the subjects and objects (as Permission objects) are stored directly in the PermissionChangeRequest message.
     ...
     */
    public PermissionChangeRequest() {
    }
     ...
     **/
    public PermissionChangeRequest(AbstractMessage mesg) {
        initFromD2D(mesg);
    }
    ...
    public void initFromD2D(AbstractMessage mesg) {
        if (mesg instanceof PermissionChangeRequestProto.PermissionChangeRequest) {
            PermissionChangeRequestProto.PermissionChangeRequest proto = (PermissionChangeRequestProto.PermissionChangeRequest) mesg;
            ...
            // The Permission message cannot store subjects, hence they are stored in the PermissionChangeRequest message
