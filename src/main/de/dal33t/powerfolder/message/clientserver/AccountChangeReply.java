...
public class AccountChangeReply extends FolderCreateReply {

    public AccountChangeReply(String replyCode, StatusCode replyStatusCode) {
    ...
    public void initFromD2D(AbstractMessage message) {
        if (message instanceof FolderRenameReplyProto.FolderRenameReply) {
            FolderRenameReplyProto.FolderRenameReply proto = (FolderRenameReplyProto.FolderRenameReply) message;
