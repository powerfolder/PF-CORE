...
public class PermissionInfoRequest extends Message implements D2DObject {
    private static final long serialVersionUID = 100L;
    private static final Logger LOG = Logger.getLogger(PermissionInfoRequest.class.getName());
    ...
    so the subjects and objects (as Permission objects) are stored directly in the PermissionInfoRequest message.
     ...
     **/
    public PermissionInfoRequest(AbstractMessage mesg) {
        initFromD2D(mesg);
    }
    ...
    public void initFromD2D(AbstractMessage mesg) {
        if (mesg instanceof PermissionInfoRequestProto.PermissionInfoRequest) {
            PermissionInfoRequestProto.PermissionInfoRequest proto = (PermissionInfoRequestProto.PermissionInfoRequest) mesg;
            ...
            // The Permission message cannot store subjects, hence they are stored in the PermissionInfoRequest message
