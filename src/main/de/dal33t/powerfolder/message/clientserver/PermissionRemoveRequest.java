...
public class PermissionRemoveRequest extends Message implements D2DObject {
    private static final long serialVersionUID = 100L;
    private static final Logger LOG = Logger.getLogger(PermissionRemoveRequest.class.getName());
    ...
    so the subjects and objects (as Permission objects) are stored directly in the PermissionRemoveRequest message.
     ...
     */
    public PermissionRemoveRequest() {
    }
     ...
     **/
    public PermissionRemoveRequest(AbstractMessage mesg) {
        initFromD2D(mesg);
    }
    ...
    public void initFromD2D(AbstractMessage mesg) {
        if (mesg instanceof PermissionRemoveRequestProto.PermissionRemoveRequest) {
            PermissionRemoveRequestProto.PermissionRemoveRequest proto = (PermissionRemoveRequestProto.PermissionRemoveRequest) mesg;
            ...
            // The Permission message cannot store subjects, hence they are stored in the PermissionRemoveRequest message
