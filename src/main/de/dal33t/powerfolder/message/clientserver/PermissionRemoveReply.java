...
public class PermissionRemoveReply extends Message implements D2DObject {
     ...
     **/
    public PermissionRemoveReply(AbstractMessage mesg) {
        initFromD2D(mesg);
    }
    ...
    public void initFromD2D(AbstractMessage mesg) {
        if (mesg instanceof PermissionRemoveReplyProto.PermissionRemoveReply) {
            PermissionRemoveReplyProto.PermissionRemoveReply proto = (PermissionRemoveReplyProto.PermissionRemoveReply) mesg;
