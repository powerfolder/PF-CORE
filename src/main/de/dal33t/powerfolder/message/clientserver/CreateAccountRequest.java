...
public class CreateAccountRequest extends Message implements D2DObject {
     ...
     **/
    public CreateAccountRequest(AbstractMessage mesg) {
        initFromD2D(mesg);
    }
    ...
    public void initFromD2D(AbstractMessage mesg) {
        if(mesg instanceof CreateAccountRequestProto.CreateAccountRequest) {
            CreateAccountRequestProto.CreateAccountRequest proto = (CreateAccountRequestProto.CreateAccountRequest)mesg;
