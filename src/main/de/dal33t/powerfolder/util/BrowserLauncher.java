...
public class BrowserLauncher {
        ...
        switch (jvm) {
            case MRJ_2_0 :
                ...
                try {
                    ...
                    putParameter.invoke(myBrowser, new Object[]{keyDirectObject,
                        aeDesc});
            ...
            case WINDOWS_9x :
                ...
                String[] arguments;
                if (jvm == WINDOWS_9x) {
                    arguments = new String[]{(String) myBrowser,
                        FIRST_WINDOWS_PARAMETER, SECOND_WINDOWS_PARAMETER, null};
                } else {
                    arguments = new String[]{(String) myBrowser,
                ...
                //String command = (String) browser + FIRST_WINDOWS_PARAMETER +
                ...
                try {
                    ...
                    if (exitCode != 0) { // if Netscape was not open
                        Runtime.getRuntime().exec(
                            new String[]{(String) myBrowser, url});
                    }
                } catch (InterruptedException ie) {
                    throw new IOException(
                        "InterruptedException while launching browser: "
    ...
    //			BufferedReader echoReader = new BufferedReader(new
    // InputStreamReader(echoStream));
