...
/**
 * This class gives access to some functions of the windows firewall.
 * Note that some methods may take some seconds to complete.
 * 
...
public class FirewallUtil {
	...
	/**
	 * Tries to open a port on the windows firewall.
	 * In case of an error it either doesn't return or it throws an IOException.
	...
	public static void openport(int port) throws IOException {
		...
		nout.println("firewall add portopening protocol=TCP port=" + port + " name=\"PowerFolder\"");
		String reply = nin.readLine();
		if (!reply.equals("netsh>Ok."))
	...
	/**
	 * Tries to close a port on the windows firewall.
	 * In case of an error it either doesn't return or it throws an IOException.
	...
	/**
	 * Tries to close one port an open another one on the windows firewall.
	 * In case of an error it either doesn't return or it throws an IOException.
	 * @param from
	 * @param to
	 * @throws IOException in case of a problem
