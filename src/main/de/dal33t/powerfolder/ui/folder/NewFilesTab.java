    ...
    HasDetailsPanel
{
    ...
    public NewFilesTab(Controller controller, FolderPanel folderPanel) {
        super(controller);
    ...
    private class Dropper extends Loggable {
        ...
        private boolean drop(File file, Directory directory) {
            ...
            NewFilesTab.this.directoryTable.getParent().setCursor(
    ...
    private class MyDropTargetListener implements DropTargetListener {
        ...
        public void drop(DropTargetDropEvent dtde) {
            ...
            if (object instanceof Directory) {
                ...
                boolean succes = NewFilesTab.this.drop((Directory) object, dtde
                    .getTransferable());
            ...
            dtde.acceptDrop(DnDConstants.ACTION_COPY);
            boolean succes = NewFilesTab.this.drop(dtde.getTransferable());
            dtde.dropComplete(succes);
        }
