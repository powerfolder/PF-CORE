    ...
    FileNameProblemHandler
{
    ...
    private Map<FileInfo, List<String>> problems;
        ...
        TableCellRenderer, TableCellEditor
    {
        ...
        private Component getProblemComponent(FileInfo fileInfo) {
            ...
            List<String> problemDesctiptions = problems.get(fileInfo);
            String tooltip = "";
            String line = "";
            for (String problem : problemDesctiptions) {
                tooltip += line + problem;
                line = "<hr>";
            }
