...
public class PauseDialog extends BaseDialog {
    ...
    static {
        ...
        PAUSE_RESUME_VALUES.put(5 * 60, Translation.getTranslation(
                "pause_dialog.pause.5minutes"));
        PAUSE_RESUME_VALUES.put(3600, Translation.getTranslation(
                "pause_dialog.pause.1hour"));
        PAUSE_RESUME_VALUES.put(8 * 3660, Translation.getTranslation(
                "pause_dialog.pause.8hours"));
        PAUSE_RESUME_VALUES.put(Integer.MAX_VALUE, Translation.getTranslation(
                "pause_dialog.pause.permanent"));
    }
    ...
    protected JComponent getContent() {
        pauseButton = new JButton(Translation.getTranslation(
                "pause_dialog.button.text"));
        ...
        builder.add(new JLabel(Translation.getTranslation(
                "pause_dialog.pause_label.text")), cc.xy(1, 1));
