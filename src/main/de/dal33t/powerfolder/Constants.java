...
public class Constants {
    ...
    static {
        ...
        try {
            nThread = Integer.valueOf(
                System.getProperty("pf.controller.threadpool.min.size", String.valueOf(nThread)));
        } catch (Exception e) {
        }
        CONTROLLER_MIN_THREADS_IN_THREADPOOL = nThread;
    }
     ...
     */
    public static final long CONNECTION_KEEP_ALIVE_TIMEOUT = 2 * 60;
    ...
    public static final List<String> SUPPORTED_LANGUAGES = Arrays.asList("en", "de", "tr", "fr", "es", "it", "pl", "nl");
