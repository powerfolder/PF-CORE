...
public class OnlineDuplicate extends AbstractBranding {
    
    private Controller controller;

    public String getName() {
        return "OnlineDuplicate";
    }

    public void init(Controller cont) {
        this.controller = cont;
        loadIcons("online_duplicate");
        loadTranslation("online_duplicate");
        loadPreConfiguration("online_duplicate", controller.getConfig());
    }
